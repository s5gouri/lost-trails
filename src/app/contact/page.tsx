        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Get in touch with our team to discuss your travel aspirations or to ask any questions about our unique experiences
            </p>
          </div>
              ...
              <div className=" border-2 rounded-lg p-8">
                <div className="mb-8">
                  ...
                  <p className="text-gray-700 mb-4">
                    We're based in Bangalore, but our team works remotely across India to research and design exceptional travel experiences.
                  </p>
                  <p className="text-gray-700 flex items-center">
                    ...
                    123 Adventure Avenue, Indiranagar, Bangalore, 560038
                  </p>
                </div>
          ...
          <div className="mb-16">
            ...
            <div className="relative h-[400px] rounded-lg overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.9942977531604!2d77.63646001744386!3d12.97069740000001!2d77.63904730000001!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae16937c123edd%3A0xd32e751b9e1deb17!2sIndiranagar%2C%20Bengaluru%2C%20Karnataka!5e0!3m2!1sen!2sin!4v1680800057583!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
